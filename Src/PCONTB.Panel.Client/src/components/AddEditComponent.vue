...
export default defineComponent({
  ...
  methods: {
    async handleSubmit() {
      this.loading = true;
      if (this.projectId) {
        this.form.userId = "2751e0ec-284f-4ba9-a5b6-81f0e0b9170b";
        this.form = await ApiClient.request("project/update", this.form);
      } else {
        this.form.userId = "2751e0ec-284f-4ba9-a5b6-81f0e0b9170b";
        this.form = await ApiClient.request("project/add", this.form);
      }
      this.loading = false;
    },
  },
