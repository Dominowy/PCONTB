...
const debouncedFetchUsers = debounce(fetchCategories, 400);
...
async function fetchCategories() {
  ...
  try {
    ...
    const response = await axios.post("/api/projects/categories/table/get-data", params);
