...
namespace PCONTB.Panel.Infrastructure.Migrations
{
    ...
    [Migration("20250706040015_RenameTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PCONTB.Panel.Domain.Projects.Categories.CategorySubcategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PCONTB.Panel.Domain.Projects.Projects.Collaborators.ProjectCollaborator", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PCONTB.Panel.Domain.Projects.Projects.Files.ProjectImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PCONTB.Panel.Domain.Projects.Projects.Files.ProjectVideo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PCONTB.Panel.Domain.Projects.Projects.Project", b =>
                {
                    ...
                    b.HasOne("PCONTB.Panel.Domain.Projects.Projects.Files.ProjectImage", "Image")
                        .WithOne("Project")
                        .HasForeignKey("PCONTB.Panel.Domain.Projects.Projects.Project", "ImageId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("PCONTB.Panel.Domain.Projects.Categories.CategorySubcategory", "Subcategory")
                        .WithMany("Projects")
                    ...
                    b.HasOne("PCONTB.Panel.Domain.Projects.Projects.Files.ProjectVideo", "Video")
                        .WithOne()
